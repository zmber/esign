    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-5">
            <p class="navbar-text navbar-right">
                <a target="_blank" href="www.kinggrid.com">技术支持</a>
            </p>
            <p class="navbar-text navbar-right">
                <a target="_blank" href="www.kinggrid.com">${user.username}</a>
            </p>
        </div>
    </div>
</nav>
...
<footer>
    <p>support by: kinggrid.com</p>
    <p>email: <a href="mailto:xxx@kinggrid.com">xxx@kinggrid.com</a>.</p>
</footer>
</body>
</html>
