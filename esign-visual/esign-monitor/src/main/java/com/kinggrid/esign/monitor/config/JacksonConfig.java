package com.kinggrid.esign.monitor.config;

import cn.hutool.core.date.DatePattern;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.module.SimpleModule;
import com.kinggrid.esign.common.core.jackson.EsignJavaTimeModule;
...
public class JacksonConfig {
	...
	public Jackson2ObjectMapperBuilderCustomizer customizer(SimpleModule adminJacksonModule) {
		return builder -> {
			...
			builder.modules(new EsignJavaTimeModule(), adminJacksonModule);
		};
	}
