package com.kinggrid.esign.common.security.util;
...
public class SecurityUtils {
	 ...
	 * 获取用户
	 */
	public EsignUser getUser(Authentication authentication) {
		Object principal = authentication.getPrincipal();
		if (principal instanceof EsignUser) {
			return (EsignUser) principal;
		}
		return null;
	}
